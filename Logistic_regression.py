...
drop_cols = ['Transaction_ID', 'User_ID', 'Timestamp', 'Risk_Score', 'Fraud_Probability']
...
clf = LogisticRegression(solver='lbfgs', max_iter=500, C=1.0, class_weight=None, random_state=42)
...
print('\n你的輸入預測結果：')
print(f'機率 = {prob:.3f}  (閾值 {THRESHOLD})')
